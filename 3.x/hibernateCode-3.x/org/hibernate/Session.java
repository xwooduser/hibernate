//$Id: Session.java,v 1.31 2005/10/06 11:06:04 steveebersole Exp $
...
public interface Session extends Serializable {
	 ...
	 *
	 * @param filterName The name of the filter to be retreived.
	 * @return The Filter instance representing the enabled fiter.
	 */
	 ...
	 * @throws org.hibernate.HibernateException if the <tt>Session</tt> is disconnected
	 * @see #reconnect()
	 * @deprecated Both {@link org.hibernate.Transaction#commit} and
	 * {@link org.hibernate.Transaction#rollback} now explicitly disconnect
	 * the session.  Conversely, {@link Session#beginTransaction} will
	 ...
	 * @throws org.hibernate.HibernateException if the <tt>Session</tt> is connected
	 * @see #disconnect()
	 * @deprecated Both {@link org.hibernate.Transaction#commit} and
	 * {@link org.hibernate.Transaction#rollback} now explicitly disconnect
	 * the session.  Conversely, {@link Session#beginTransaction} will

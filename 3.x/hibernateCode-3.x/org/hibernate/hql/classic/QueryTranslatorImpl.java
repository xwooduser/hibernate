//$Id: QueryTranslatorImpl.java,v 1.28 2005/08/15 22:42:28 oneovthafew Exp $
...
public class QueryTranslatorImpl extends BasicLoader
	...
	public String[] getReturnAliases() {
		throw new UnsupportedOperationException("select clause aliases are not supported by classic parser");
	}
	...
	public Iterator iterate(QueryParameters queryParameters, EventSource session)
		...
		try {
			...
			HolderInstantiator hi = new HolderInstantiator(holderConstructor, false, false, null);

// $Id: MultiTableUpdateExecutor.java,v 1.3 2005/09/30 17:55:45 steveebersole Exp $
...
public class MultiTableUpdateExecutor extends AbstractStatementExecutor {
	...
	public MultiTableUpdateExecutor(HqlSqlWalker walker) {
		...
		this.updateStatement = ( UpdateStatement ) walker.getAST();
		...
		for ( int tableIndex = 0; tableIndex < tableNames.length; tableIndex++ ) {
			...
			itr = assignmentSpecifications.iterator();
			while ( itr.hasNext() ) {

// $Id: HqlSqlWalker.java,v 1.108 2005/09/28 20:33:33 steveebersole Exp $
...
//			if ( fromElement.isFetch() && fromElement.isCollectionJoin() ) {
	...
	protected void postProcessInsert(AST insert) throws SemanticException, QueryException {
		...
		if ( includeVersionProperty ) {
			// We need to re-seed the version value as part of this bulk insert
			VersionType versionType = persister.getVersionType();

			AST versionValue = getASTFactory().create( HqlSqlTokenTypes.PARAM, "?" );
			ParameterSpecification paramSpec = new VersionTypeSeedParameterSpecification( versionType );
			( ( ParameterNode ) versionValue ).setHqlParameterSpecification( paramSpec );
			parameters.add( 0, paramSpec );

			AST currentFirstSelectExprNode = selectClause.getFirstChild();
			selectClause.setFirstChild( versionValue );
			versionValue.setNextSibling( currentFirstSelectExprNode );
    ...
    protected void setRoot(AST ast) {
        ( (IdentNode) ast).setRoot();
    }

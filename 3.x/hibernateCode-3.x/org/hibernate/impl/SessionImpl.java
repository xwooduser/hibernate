//$Id: SessionImpl.java,v 1.161 2005/10/07 14:46:30 steveebersole Exp $
...
public final class SessionImpl extends AbstractSessionImpl 
	...
	private boolean autoClear; //for EJB3
	...
	private void writeObject(ObjectOutputStream oos) throws IOException {
		if ( jdbcContext.getConnectionManager().isPhysicallyConnected() ) {
	...
	public void load(Object object, Serializable id) throws HibernateException {
		...
		for ( int i = 0; i < loadEventListener.length; i++ ) {
			loadEventListener[i].onLoad(event, LoadEventListener.RELOAD);
		}
	}
	...
	public Object internalLoad(String entityName, Serializable id, boolean eager, boolean nullable) throws HibernateException {
		...
		LoadEvent event = new LoadEvent(id, entityName, true, this);
		fireLoad(event, type);
		if (!nullable) UnresolvableObjectException.throwIfNull( event.getResult(), id, entityName );
		return event.getResult();
	}
	...
	public Query createFilter(Object collection, String queryString) {
		CollectionFilterImpl filter = new CollectionFilterImpl(queryString, collection, this);

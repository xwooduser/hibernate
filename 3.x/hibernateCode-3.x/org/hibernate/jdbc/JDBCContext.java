// $Id: JDBCContext.java,v 1.20 2005/10/06 22:11:31 turin42 Exp $
...
public class JDBCContext implements Serializable, ConnectionManager.Callback {
	...
	public Connection connection() throws HibernateException {
		...
		else if ( !connectionManager.isLogicallyConnected() ) {
	...
	public boolean isTransactionInProgress() {
		...
		if ( isHibernateTransactionActive ) {
			return true;
		}
		else {
			return JTAHelper.isTransactionInProgress( owner.getFactory() );
		}
	}

...
and the target directory for the extracted binary (defaults to _/var/lib/jenkins/jobs/hibernate-ogm-release/workspace/distribution/target/embeddedMongoDb/extracted_) like this:
